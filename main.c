...
#if defined(__RTE_ACCELERATION_ARM_2D_EXTRA_BENCHMARK_WATCH_PANEL__) || defined(__RTE_ACCELERATION_ARM_2D_EXTRA_BENCHMARK_GENERIC__)
...
int main(void)
{
    ...
    while (true)
    {
        ...
        {
            if (res == 2)
                gameScene->game_status = GAME_END;
            if (res == 3)
                gameScene->game_status = GAME_WIN;
        }
        else
        {
